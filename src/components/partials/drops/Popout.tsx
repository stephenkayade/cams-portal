...

                                {
                                    ...
                                    search.map((item, index) =>
                                        <Fragment key={`${item.value}-${index + 1}`}>
                                            <Link onClick={(e) => selectItem(e, item.value)} to="" className={`filter-item ${menu.fullWidth ? '' : menu.className} ${item.disabled ? 'pointer-events-none opacity-[0.45]' : ''}`}>
                                                {
                                                    item.image &&
                                                    <>
                                                ...
                                                }
                                                {
                                                    item.icon &&
                                                    <>
                                                        <Icon type={item.icon.type} name={item.icon.name} size={item.icon.size || 14} className="pag-600" />
                                                        <span className="pl-[0.1rem]"></span>
                                                    </>
                                                }
