            ...
            <>
                {
                    ...
                    <>
                        ...
                        <span className="text-[13px] font-mona pag-600 relative pr-[0.5rem] truncate top-[0px]">{selected.display ? selected.display : selected.label}</span>
                    </>
                }
                {
                    ...
                    selectedList.map((item, index) =>
                        <Fragment key={item.value + index}>
                            ...
                            <span className="text-[13px] font-mona pag-600 relative pr-[0.5rem] truncate top-[0px]">{item.display ? item.display : item.label}</span>
                        </Fragment>
                    )
                }
            </>
        ...
        <>
            <div className={cc()}>
                ...
                <div onClick={(e) => toggleMenu(e)} className={`selected ${ch.h}`}>
                    ...
                    {!multiple && !selected && <span className="text-[13px] font-mona pag-600 relative pr-[0.5rem] truncate top-[0px]">{placeholder}</span>}
                    {multiple && selectedList.length === 0 && <span className="text-[13px] font-mona pag-600 relative pr-[0.5rem] truncate top-[0px]">{placeholder}</span>}
