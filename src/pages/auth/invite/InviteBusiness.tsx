...
const InviteBusinessPage = ({ }) => {
    ...
    const handleAccept = async (token: string) => {
        ...
        setLoading(true);
        const response = await acceptInvite({ token: token ? token : '', type: 'business' })
                                    ...
                                    <div className="w-[60%] mx-auto my-0 text-center space-y-[1rem]">
...

                                        {
                                            ...
                                            <>
                                                ...
                                                {
                                                    alert.show === false &&
                                                    <EmptyState bgColor="bg-pag-50" className="min-h-[40vh]" noBound={true}>
                                                        <div className="mb-[1.3rem]">
                                                            <Icon type="feather" name="info" className="pap-600" size={80} />
                                                        </div>
                                                        <p className="mb-[1.3rem] font-mona text-[16px] pag-900">Something went wrong. Reload page, try <br /> to login or use forgot password.</p>
                                    ...
                                    <div className="w-[60%] mx-auto my-0">
                                        ...
                                        <Message
                                            ...
                                            button={{
                                                enable: true,
                                                text: "Continue",
                                                onClick: (e) => { goTo('/dashboard/onboard') }
                                            }}
                                        />
...
export default InviteBusinessPage;
