            ...
            <section className="w-full min-h-[100vh]">
                ...
                <EmptyState className="min-h-[80vh] max-w-[80%] mx-auto my-[10vh] full-bg" noBound={true} style={{ backgroundImage: `url("../../../images/assets/bg@grad_01.webp")` }}>
                    <div className="space-y-[1.5rem] text-center">
                        ...
                        <div><Icon name="wifi-off" type="feather" className="pas-900" size={80} /></div>
                        <div>
                            <span className="font-mona-light pag-800 text-[35px]">Your internet is down currently</span>
                        </div>
                        <div>
                            <Button
                                type="primary"
