...
interface IUseSize {
    size: SizeType,
    type?: 'input' | 'filter' | 'button' | 'checkbox' | 'input-icon' | 'modal' | 'switch'
}
...
const useSize = (props: IUseSize) => {
    ...
    const switchMap: Record<SizeType, { track: string; knob: string; translate: string }> = {
        xmini: { track: "h-5 w-9", knob: "h-4 w-4", translate: "translate-x-4" },
        mini: { track: "h-5 w-9", knob: "h-4 w-4", translate: "translate-x-4" },
        xxsm: { track: "h-5 w-9", knob: "h-4 w-4", translate: "translate-x-4" },
        xsm: { track: "h-5 w-9", knob: "h-4 w-4", translate: "translate-x-4" },
        sm: { track: "h-5 w-9", knob: "h-4 w-4", translate: "translate-x-4" },
        rg: { track: "h-5 w-9", knob: "h-4 w-4", translate: "translate-x-4" },
        default: { track: "h-5 w-9", knob: "h-4 w-4", translate: "translate-x-4" },
        md: { track: "h-6 w-11", knob: "h-5 w-5", translate: "translate-x-5" },
        lg: { track: "h-8 w-14", knob: "h-7 w-7", translate: "translate-x-6" },
        xlg: { track: "h-8 w-14", knob: "h-7 w-7", translate: "translate-x-6" },
        xxlg: { track: "h-8 w-14", knob: "h-7 w-7", translate: "translate-x-6" },
        lgr: { track: "h-8 w-14", knob: "h-7 w-7", translate: "translate-x-6" },
    };
